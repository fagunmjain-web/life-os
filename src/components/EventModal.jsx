      ...
      <div style={modal}>
          ...
          <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
            {types.map(t => (
              <button key={t.key} onClick={() => setType(t.key)} style={{
                flex: 1, minWidth: 80, padding: '7px 0', fontSize: 15, fontWeight: 600, borderRadius: 8,
                border: 'none',
        ...
        {type === 'celebration' && (
          <div style={{ marginBottom: 14, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <span style={{ fontSize: 16, fontWeight: 600, color: '#2C2C2C' }}>Repeat annually</span>
...
const fieldLabel = { fontSize: 13, fontWeight: 600, color: '#888', textTransform: 'uppercase', letterSpacing: '.04em', marginBottom: 4 }
const input      = { width: '100%', padding: '8px 10px', border: '1px solid #EBEBEB', borderRadius: 8, fontSize: 16, color: '#2C2C2C', background: '#f9f9f9', fontFamily: 'inherit', outline: 'none' }
